...
for date_for_test in date_list:
    ...
    horizon = 287  # Установите длину горизонта предсказания

    X, y = split_sequence(values, lag, horizon)
    ...
    model_path = '/Users/nikitasavvin/Desktop/Учеба/LCR_forecast/model_predict.h5'
...
#     model = load_model(model_path)
    ...
    print(f'MAPE = {mape}  | {date_for_test}')
