...
cnn_lstm_model.add(Conv1D(filters=64, kernel_size=2, activation='relu', input_shape=(lag, n_features)))
cnn_lstm_model.add(MaxPooling1D(pool_size=2))

cnn_lstm_model.add(Conv1D(filters=128, kernel_size=2, activation='relu'))
cnn_lstm_model.add(MaxPooling1D(pool_size=2))
